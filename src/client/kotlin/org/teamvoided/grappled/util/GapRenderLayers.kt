        ...
        Util.memoize { texture ->
            RenderLayer.of(
                ...
                MultiPhaseParameters.builder()
                    .shader(RenderPhase.ENTITY_CUTOUT_NONNULL_SHADER) //make custom shader for this also copy `RenderPhase.ENTITY_CUTOUT_NONNULL_SHADER`
